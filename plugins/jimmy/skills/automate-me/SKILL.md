...
The **jimmy mode** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as jimmy mode's.
...
- The **jimmy mode** skill: example of the output shape.
